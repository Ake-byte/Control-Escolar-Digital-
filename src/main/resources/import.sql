...
INSERT INTO expediente(user_id, semestre, grado, estatus_escolar, beca_conacyt, num_semestre, numero_registro) VALUES(2,'A21', 'Maestría', 'Inscrito', TRUE, 3, 'A211234');
...
INSERT INTO expediente(user_id, semestre, grado, estatus_escolar, beca_conacyt, num_semestre, numero_registro) VALUES(3,'A21', 'Doctorado', 'Inscrito', TRUE, 3, 'A211234');
...
INSERT INTO users (nombre,apellido_paterno, apellido_materno, email, pwd, enabled) values('Víctor Manuel', 'Melgarejo', 'Cázares',	'vmelgarejocaz@gmail.com', '$2a$10$jolsV/dR6BhNVVQ6FV/sPOWa4cHFfevLZQJN5N5WUgVVxtipyqS5S',FALSE);
...
INSERT INTO expediente(user_id, semestre, grado, estatus_escolar, beca_conacyt, num_semestre, numero_registro) VALUES(5,'A21', 'Maestría', 'Inscrito', TRUE, 3, 'B221234');