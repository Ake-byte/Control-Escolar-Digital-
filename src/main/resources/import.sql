...
insert into users (nombre,apellido_paterno, apellido_materno, email, pwd, enabled, genero, foto_status, acta_status, pasaporte_status, curp_status) values('Rayko', 'Amaro', 'Hernández', 'ramah920425@gmail.com', '$2a$10$eHXHUCQ8lhB4JJCeIEbvFeWWGT1aNh6etQLSq7U4dYBQnjqtSqJMy',TRUE,'Hombre',0,0,0,0);
...
insert into users (nombre,apellido_paterno, apellido_materno, email, pwd, enabled, genero, foto_status, acta_status, pasaporte_status, curp_status) values('Camilo', 'Serrano', 'Fuentes',	'camilosf.92@gmail.com', '$2a$10$DKrGizoxOMGu84/NIpq02e6ktGtajQ7JdPfz6uL8jUxjHyIhxWyDm',TRUE,'Hombre',0,0,0,0);
...
insert into users (nombre,apellido_paterno, apellido_materno, email, pwd, enabled, genero, foto_status, acta_status, pasaporte_status, curp_status) values('Francisco Daniel', 'Ramírez', 'Apodaca','apodaca9207@gmail.com', '$2a$10$8/n4xz.4radWshhjSMh.huS.RQfbaf04I1exIn/LNOifFav/ijdLe',TRUE,'Hombre',0,0,0,0);
